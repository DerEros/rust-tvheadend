...
use crate::protocol::message_serializer::MessageSerializer;
use anyhow::Result;
use log::*;
use serde::ser::{
...
impl SerializeSeq for RequestSerializer {
    type Ok = Fields;
    type Error = Error;
...
impl SerializeTuple for RequestSerializer {
    type Ok = Fields;
    type Error = Error;
...
impl SerializeTupleStruct for RequestSerializer {
    type Ok = Fields;
    type Error = Error;
...
impl SerializeTupleVariant for RequestSerializer {
    type Ok = Fields;
    type Error = Error;
...
impl SerializeMap for RequestSerializer {
    type Ok = Fields;
    type Error = Error;
...
impl SerializeStruct for RequestSerializer {
    type Ok = Fields;
    type Error = Error;
...
impl SerializeStructVariant for RequestSerializer {
    type Ok = Fields;
    type Error = Error;
